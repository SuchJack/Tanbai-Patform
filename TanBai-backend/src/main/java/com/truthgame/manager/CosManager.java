...
import com.truthgame.config.CosClientConfig;
...
import static com.truthgame.constant.PosterConstant.BASE_URL;
...
public class CosManager {
    ...
    public String uploadBytes(byte[] bytes, String fileName) {
        try {
            // 生成唯一的文件名
            String key = "user_avatar/qrcode/" + fileName; // todo 暂时写死
