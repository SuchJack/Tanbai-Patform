...
import com.truthgame.constant.Constants;
...
public class IpUtil {
    ...
    private final static String format_url = "https://apis.map.qq.com/ws/location/v1/ip?ip={}&key=XXXXXXXXXXXX";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getIp2region("120.82.32.62"));
        System.out.println(getIp2region("202.68.68.50"));
        System.out.println(getIp2region("202.168.168.50"));
        System.out.println(getIp2region("127.0.0.1"));
    }
    /**
     * 获取访问设备
     *
